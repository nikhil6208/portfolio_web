            ...
            <div>
                ...
                <div className='mb-[3rem] flex items-center md:space-x-10'>
                    ...
                    <p className='text-[19px] text-slate-300 w-[80%]'>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis, natus quaerat 
                        blanditiis reprehenderit obcaecati expedita, quidem dolores consequatur possimus 
                        architecto deserunt rerum sequi quibusdam esse aut quisquam unde quo numquam.
                    </p>
                </div>
