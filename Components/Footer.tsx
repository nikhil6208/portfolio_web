        ...
        <div className="grid border-b-[1px] pb-[6rem] border-gray-400 grid-cols-1 lg:grid-cols-3 md:grid-cols-2 w-[80%] mx-auto gap-[3rem]">
            <div className="flex items-center space-x-6">
                ...
                <div>
                    ...
                    <p className="text-[17px] w-[90%] text-white opacity-60">Lorem, ipsum dolar sit</p>
                </div>
            </div>
            <div className="flex items-center space-x-6">
                <div className="md:w-[6.5rem] md:h-[6.5rem] w-[5rem] h-[5rem] flex items-center justify-center rounded-full bg-[#55e6a5]">
                ...
                <div>
                    ...
                    <p className="text-[17px] w-[90%] text-white opacity-60">+912398902302<br />+918967564473</p>
                </div>
            </div>
            <div className="flex items-center space-x-6">
                <div className="md:w-[6.5rem] md:h-[6.5rem] w-[5rem] h-[5rem] flex items-center justify-center rounded-full bg-[#55e6a5]">
                ...
                <div>
                    ...
                    <p className="text-[17px] w-[90%] text-white opacity-60">example.com<br />example@gmail.com</p>
                </div>
            </div>
        </div>
        <div className="w-[80%] mt-[2rem] mx-auto grid grid-cols-1 md:grid-cols-2 items-center justify-between">
            <div className="text-[18px] mb-[2rem] md:mb-0 text-white opacity-20">
                Webdev Worriors 20204 | All rights Reserved
            </div>
            <div className="flex items-center space-x-10">
                ...
                <p className="text-[18px] text-white opacity-20">Contact</p>
            </div>
        </div>
    </div>
  )
