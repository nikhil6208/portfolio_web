  ...
  return (
    <div className="flex flex-col text-center justify-center">
        ...
        <div className="flex" items-center mx-auto>
            <StarIcon className="w-[2rem] h-[2rem] text-yrllow-500" />
            <StarIcon className="w-[2rem] h-[2rem] text-yrllow-500" />
            <StarIcon className="w-[2rem] h-[2rem] text-yrllow-500" />
            <StarIcon className="w-[2rem] h-[2rem] text-yrllow-500" />
            <StarIcon className="w-[2rem] h-[2rem] text-yrllow-500" />
        ...
        <p className="text-[16px] text-white opacity-50 w-[90%] md:w-[50%] mx-auto">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia dolorum voluptate unde 
            enim molestiae? Repudiandae sit nulla commodi eligendi quod blanditiis, aut et 
            excepturi debitis iusto quibusdam deleniti ad vel.
        </p>
    </div>
  );
};
