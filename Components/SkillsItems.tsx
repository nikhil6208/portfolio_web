...
const SkillsItems  = ({ title, year}: Props) => {
  return <div className='mb-[4rem] md:mb-[8rem]'>
    ...
    <p className='text-[#aaaaaa] font-normal w-[80%] text-[17px] opacity-80'>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor sed nesciunt quam reprehenderit. Dolor blanditiis eligendi doloremque voluptatibus ratione nesciunt obcaecati porro incidunt placeat? Veniam eligendi cumque quia neque distinctio?
    </p>
  </div>
};
